        ...
        <form action="{{ route('employees.store') }}" method="POST">
            ...
            <div class="row justify-content-center">
                <div class="p-5 bg-light rounded-3 border col-xl-6">
                    ...
                    {{-- commen bagian ini agar bentuk validasi sesuai dengan yang diinginkan --}}
                    {{-- @if ($errors->any())
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            {{-- Masukkan Displaying The Validation Errors pada class --}}
                            {{-- isikan value dengan code tsb agar dapat menampilkan lama untuk mengisi ulang formulir --}}
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <select name="position" id="position" class="form-select">
                                {{-- untuk memulai perulangan (loop) pada array $positions --}}
